...
class uiShowDataWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Excel Datei"))
        self.label.setText(_translate("MainWindow", "    Importieren List von Excel Datei"))
